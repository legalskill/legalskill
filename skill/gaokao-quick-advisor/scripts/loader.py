...
# 城市→省份映射（用户说"苏州"→自动识别为江苏，而非静默回退河北）
CITY_TO_PROVINCE = {
    # 省会/首府
    '石家庄': '13', '太原': '14', '呼和浩特': '15',
    '沈阳': '21', '长春': '22', '哈尔滨': '23',
    '南京': '32', '杭州': '33', '合肥': '34', '福州': '35', '南昌': '36', '济南': '37',
    '郑州': '41', '武汉': '42', '长沙': '43', '广州': '44', '南宁': '45',
    '成都': '51', '贵阳': '52', '昆明': '53', '拉萨': '54',
    '西安': '61', '兰州': '62', '西宁': '63', '银川': '64', '乌鲁木齐': '65',
    # 高频非省会城市
    '深圳': '44', '苏州': '32', '厦门': '35', '青岛': '37', '大连': '21',
    '宁波': '33', '东莞': '44', '佛山': '44', '无锡': '32', '温州': '33',
    '珠海': '44', '三亚': '46', '桂林': '45', '徐州': '32', '常州': '32',
    '烟台': '37', '威海': '37', '泉州': '35', '惠州': '44', '中山': '44',
    '汕头': '44', '洛阳': '41', '唐山': '13',
}
