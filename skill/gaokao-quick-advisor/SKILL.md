...
metadata:
  ...
  tags: >-
    ...
    高考, 志愿, 志愿填报, 高考志愿, 报志愿, 志愿推荐, 高考志愿推荐,
    高考志愿规划, 院校推荐, 大学推荐, 学校推荐, 高校推荐,
    录取概率, 录取率, 录取希望, 录取可能性, 录取概率估算,
    冲稳保, 冲刺稳妥保底,
    一分一段, 一分一段表, 省排名, 位次, 高考位次,
    分数线, 省控线, 本科线, 专科线, 批次线,
    选科, 物理类, 历史类, 文科, 理科,
    高考分数, 高考成绩, 考分,
    能上什么学校, 能上哪些学校, 能报什么大学, 能考上什么学校,
    帮我推荐学校, 帮我报志愿, 帮我填志愿, 帮我看看能上什么,
    极简交互, 一问出结果, 31省全覆盖
  updated_at: "2026-06-07T20:24:00Z"
...
- [ ] 尾部包含数据年份说明
- [ ] 尾部包含引导提示（2 条追问问题）
- [ ] 尾部包含微信引导行（"微信 89930280 获取专家深度个性报告"）——此行为脚本 stdout 尾部自带，Agent 展示简报时须原样保留，不可截断丢弃
...
- 学校名保留官网超链接
- 保留脚本输出中的引导提示（2 条追问问题 + 微信引导行 "微信 89930280"，不可截断）
