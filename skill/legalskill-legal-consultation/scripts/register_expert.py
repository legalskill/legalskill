...
Examples:
    python3 register_expert.py ~/.workbuddy/plugins/marketplaces/my-experts/plugins/my-expert
    python3 register_expert.py ./my-expert --marketplace-dir ~/.workbuddy/plugins/marketplaces/my-experts
...
def get_marketplace_dir(expert_dir: Path, explicit_marketplace_dir: Optional[str]) -> Path:
    ...
    # Fallback to default
    return Path.home() / '.workbuddy' / 'plugins' / 'marketplaces' / 'my-experts'
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExamples:")
        print("  python3 register_expert.py ~/.workbuddy/plugins/marketplaces/my-experts/plugins/my-expert")
        print("  python3 register_expert.py ./my-expert --marketplace-dir ~/.workbuddy/plugins/marketplaces/my-experts")
        sys.exit(1)
